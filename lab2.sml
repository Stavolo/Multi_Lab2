...
fun is_older (date(a1,b1,c1) : date, date(a2,b2,c2) : date) =
    if a1 = a2 andalso b1 = b2 andalso c1 = c2 then false
...
(*test for task1*)
val _ = print( Bool.toString( is_older (date(2000, 12, 1), date(2000, 11, 1)) ) ^ "\n" );
...
(*task11*)
val t11_l = [date(2000, 13, 1), date(2000, 12, 1), date(2001, 1, 1), date(2000, 11, 2)]
